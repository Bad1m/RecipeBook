...
{
    public class UpdateIngredientHandler : IRequestHandler<UpdateIngredient, IngredientDto>
    {
        ...
        public async Task<IngredientDto> Handle(UpdateIngredient request, CancellationToken cancellationToken)
        {
